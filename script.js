...
const retrieveEntries = () => {
  let ents = localStorage.getItem("userEntry");
...
const dispEntries = () => {
  ...
  let tableDivision = document.getElementById("tableDiv");

  
  tableDivision.innerHTML = `<table class="table" border="2">
  <tr>
    <th class="th">Name</th>
...
form.addEventListener("submit", saving);
